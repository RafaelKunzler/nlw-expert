...
export function NewNoteCard({ onNoteCreated }: newNoteCardProps) {
    ...
    return(
        <Dialog.Root>
            <Dialog.Trigger className='rounded-md flex flex-col outline-none bg-slate-700 text-left p-5 gap-3 hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
